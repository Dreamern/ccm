...
class OTPlanSampler:
    ...
    def get_map(self, x0, x1, M=None):
        ...
        # M2 = torch.cdist(x0, x1) ** 2
        # MM1 = torch.argmax(M, dim=1)
        # MM2 = torch.argmax(M2, dim=1)
    ...
    def sample_plan(self, x0, x1, replace=True, M=None):
